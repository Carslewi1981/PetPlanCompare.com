...
const PET_TYPES: PetType[] = [
  {
    ...
    photos: [
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/d/d0/German_Shepherd_-_DSC_0346_%2810096362833%29.jpg", caption: "German Shepherd", detail: "Rex, 5 yrs", fallback: "🦮" },
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/b/be/%EB%8B%A5%EC%8A%A4%ED%9B%88%ED%8A%B8%28%EB%8B%A8%EB%AA%A8%EC%A2%85%29_%28Dachshund_%28Short%29%29.jpg", caption: "Dachshund", detail: "Pretzel, 4 yrs", fallback: "🐕" },
