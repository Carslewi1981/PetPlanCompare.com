...
const PET_TYPES: PetType[] = [
  {
    ...
    photos: [
      ...
      { url: u("1586671267731-da2cf3ceeb80"), caption: "Labrador", detail: "Sunny, 2 yrs", fallback: "🐕" },
      { url: u("1631048905843-88f82fba8fd4"), caption: "Beagle", detail: "Biscuit, 3 yrs", fallback: "🐶" },
      { url: u("1596116082596-7a0da930b9aa"), caption: "Dachshund", detail: "Pretzel, 4 yrs", fallback: "🐕" },
      { url: u("1537151608828-ea2b11777ee8"), caption: "Corgi", detail: "Winston, 2 yrs", fallback: "🐾" },
    ],
  },
  {
    id: "cat",
    ...
    photos: [
      ...
      { url: u("1496284575094-d5b92db3890d"), caption: "Bengal", detail: "Nala, 2 yrs", fallback: "🐱" },
  ...
  },
  {
    ...
    photos: [
      ...
      { url: u("1540979129101-fef4ab23dbd6"), caption: "Budgerigar", detail: "Pickles, 4 yrs", fallback: "🦜" },
      { url: u("1618999385326-b98e613ea109"), caption: "Cockatoo", detail: "Snowy, 10 yrs", fallback: "🦜" },
    ],
  },
  {
    id: "rabbit",
  ...
  },
  {
    ...
    photos: [
      ...
      { url: u("1610604695612-ae85d1a6e54e"), caption: "Green Iguana", detail: "Verde, 6 yrs", fallback: "🦎" },
      ...
      { url: u("1597776941486-054bf5529210"), caption: "Tortoise", detail: "Hercules, 20 yrs", fallback: "🐢" },
  ...
  },
  {
    ...
    photos: [
      ...
      { url: u("1628832824905-819f2385fd82"), caption: "Chinchilla", detail: "Ash, 2 yrs", fallback: "🐭" },
      { url: u("1779806526793-499ff802e37f"), caption: "Hamster", detail: "Biscuit, 1 yr", fallback: "🐹" },
      ...
      { url: u("1548261292-20a97908dc9e"), caption: "Pet Rat", detail: "Remy, 2 yrs", fallback: "🐀" },
    ],
  },
];
